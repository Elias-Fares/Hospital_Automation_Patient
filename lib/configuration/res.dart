class Res {
  ...
  static const authIconPath = "$iconPath/auth";
  static const authImagePath = "$imagesPath/auth";

  static const mainScreenIconPath = "$iconPath/main_screen";
  ...
  static const String verificationCodeImage =
      "$authImagePath/verification_code_image$png";
  static const String uploadImage = "$authImagePath/upload_image$png";
  static const String personePlaceHolderImage =
      "$authImagePath/persone_placeholder$jpeg";
