...
import '../../perscriptions/models/prescription_model.dart';

class MedicalRecordModel extends GeneralModel {
  final DoctorModel? doctorInfo;
  final List<AppointmentModel>? doctorsAppointments;
  final List<PrescriptionModel>? doctorPrescription;
  ...
  MedicalRecordModel copyWith({
    ...
    List<AppointmentModel>? doctorsAppointments,
    List<PrescriptionModel>? doctorPrescription,
  }) =>
      MedicalRecordModel(
  ...
  factory MedicalRecordModel.fromJson(Map<String, dynamic> json) =>
      MedicalRecordModel(
        ...
        doctorsAppointments: json["doctorsAppointments"] == null
            ? []
            : List<AppointmentModel>.from(json["doctorsAppointments"]!
                .map((x) => AppointmentModel.fromJson(x))),
        doctorPrescription: json["doctorPrescription"] == null
            ? []
            : List<PrescriptionModel>.from(json["doctorPrescription"]!
